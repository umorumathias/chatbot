function start() {
    ...
    res_msg.innerHTML = "Hello, How can i help you?"; res_msg.setAttribute("class","left");
...
document.getElementById("send").addEventListener("click", async (e) =>
{
    ...
    if (req == undefined || req == "") {
        ...
        let res = "";
        await axios.get(`https://api.monkedev.com/fun/chat?msg=${req}`).then(data => { res = JSON.stringify(data.data.response)
